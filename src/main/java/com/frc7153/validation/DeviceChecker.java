...
public class DeviceChecker {
     ...
     * @return Whether this device is valid (working)
     */
    public static boolean validateMotor(CANSparkMax spark) { return !spark.getFault(FaultID.kCANRX) && !spark.getFault(FaultID.kCANTX) && !spark.getFault(FaultID.kMotorFault) && !spark.getFault(FaultID.kOvercurrent) && !spark.getFault(FaultID.kBrownout); }
     ...
     * @return Whether all the channels are working
     */
