...
import com.frc7153.validation.ValidatedObject;

import edu.wpi.first.wpilibj.PowerDistribution;
import edu.wpi.first.wpilibj.PowerDistribution.ModuleType;
import frc.robot.Constants.PDHConstants;

public class PDH extends ValidatedObject {
    // PDH
    ...
    public HashMap<String, Boolean> validate() {
        ...
        validationMap.put("PDH Channels", DeviceChecker.validatePowerDistributionChannels(hub, PDHConstants.kUSED_CHANNELS));
